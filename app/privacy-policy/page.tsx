...
export default function PrivacyPolicyPage() {
  return (
    <PolicyTemplate
      ...
      summary="At VEYRA, we are committed to safeguarding your personal information. This Privacy Policy explains how we collect, use, and protect your data when you browse our website, place orders, or request products from Indian marketplaces."
      sections={[
        {
