      ...
      sections={[
        {
          ...
          content: "SAJILOMARTS operates as an independent shopping facilitator and freight concierge in Nepal. We do not claim official partnership with Amazon India, Flipkart, Myntra, Meesho, Ajio, or Tata CLiQ unless explicitly stated. All third-party logos and trademarks belong to their respective owners."
        },
        {
        ...
        },
        {
          ...
          content: "Every custom quote provided by SAJILOMARTS includes: Indian marketplace price converted at current exchange rate, international transit freight, estimated Nepal customs duty, handling/packaging fee, and domestic Nepal delivery."
        },
        {
