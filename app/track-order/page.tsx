    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="text-center max-w-xl mx-auto">
        ...
        <p className="mt-2 text-xs sm:text-sm text-neutral-500">
          Enter your VEYRA Order ID to check the current sourcing, transit and Nepal doorstep delivery milestone.
        </p>
      </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              required
              placeholder="e.g. VEYRA-ORD-10245"
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
          <div className="flex items-center gap-2 text-xs text-neutral-500">
            ...
            <button
              type="button"
              onClick={() => {
                setOrderIdInput("VEYRA-ORD-10245");
      ...
      {submitted && orderDetails && (
        <div className="mt-8 rounded-3xl border border-neutral-200 bg-white p-6 sm:p-8 shadow-card space-y-8 animate-fade-in">
                  ...
                  <div key={stepName} className="relative flex items-start gap-4">
                    ...
                    <div className="flex-1 pt-0.5">
                      ...
                      <p className="mt-0.5 text-xs text-neutral-500">
                        {idx === 0 && "Order recorded and verified in VEYRA system."}
                        ...
                        {idx === 5 && "Cleared customs and arrived at VEYRA Nepal Central Hub."}
          ...
          <div className="rounded-2xl border border-neutral-200 bg-neutral-50/70 p-4 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            ...
            <a
              href="https://wa.me/9779800000000?text=Hi%20VEYRA%2C%20I%20have%20an%20inquiry%20regarding%20my%20order"
              target="_blank"
              rel="noreferrer"
