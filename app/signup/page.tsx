...
function SignupContent() {
  ...
  const handleAppleSignup = async () => {
    if (!appleProvider || !firebaseAuth) {
      ...
      pushToast("Apple Sign-Up unavailable.", "error");
      return;
    }
        ...
        <div className="lg:col-span-5 bg-gradient-to-br from-[#0B0F19] via-[#0F172A] to-[#0A192F] p-8 lg:p-12 text-white flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-800/80 relative overflow-hidden">
          ...
          <div className="relative z-10 my-8 space-y-3">
            <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md">
              ...
              <div>
                <h4 className="text-xs font-bold text-white">Direct India ➔ Nepal Sourcing</h4>
            ...
            <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400">Instant landed quotes &amp; printable PDF invoices.</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md">
              ...
              <div>
                ...
                <p className="text-[11px] text-slate-400">Doorstep delivery across all 7 provinces of Nepal.</p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-md mx-auto w-full space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">
                Sign up to order from Indian marketplaces with doorstep delivery in Nepal.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-2xl border border-slate-700/80 bg-slate-900/60 pl-10 pr-4 py-2.5 text-xs font-semibold text-white placeholder:text-slate-500 focus:border-blue-500 focus:bg-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-500 transition shadow-inner"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    minLength={6}
                    placeholder="••••••••"
                    className="w-full rounded-2xl border border-slate-700/80 bg-slate-900/60 pl-10 pr-10 py-2.5 text-xs font-semibold text-white placeholder:text-slate-500 focus:border-blue-500 focus:bg-slate-900 focus:outline-none focus:ring-1 focus:ring-blue-500 transition shadow-inner"
                  />
                  <button
                    type="button"
