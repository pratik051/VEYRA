...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-[#07090E] flex items-center justify-center p-4 sm:p-6 lg:p-10 relative overflow-hidden">
      {/* ─── AMBIENT ELECTRIC BLUE GLOWS (Figma Aesthetic) ─── */}
      ...
      <div className="w-full max-w-5xl bg-[#0B0F19]/90 backdrop-blur-2xl rounded-3xl border border-slate-800/80 shadow-2xl shadow-blue-950/40 overflow-hidden grid grid-cols-1 lg:grid-cols-12 min-h-[640px] relative z-10">
        ...
        <div className="lg:col-span-5 bg-gradient-to-br from-[#0B0F19] via-[#0F172A] to-[#0A192F] p-8 lg:p-12 text-white flex flex-col justify-between border-b lg:border-b-0 lg:border-r border-slate-800/80 relative overflow-hidden">
          ...
          <div className="relative z-10 my-8 space-y-3">
            ...
            <div className="flex items-center gap-3.5 p-3.5 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md">
              ...
              <div>
                <h4 className="text-xs font-bold text-white">Live Sourcing Tracking</h4>
                <p className="text-[11px] text-slate-400">Door-to-door delivery across all 7 provinces of Nepal.</p>
              </div>
            </div>
          </div>
        ...
        {/* ─── RIGHT COLUMN: FIGMA AUTH FORM (Electric Blue Theme) ─── */}
        <div className="lg:col-span-7 p-8 sm:p-12 lg:p-14 flex flex-col justify-center bg-[#0D121F]/95 relative">
          ...
          <div className="max-w-md mx-auto w-full space-y-6">
            ...
            {/* Header Title */}
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 text-[#00A3FF] text-[11px] font-bold mb-3">
                <span>⚡</span>
              ...
              <p className="text-xs text-slate-400 mt-1">
                {isForgot
                  ? "Receive a 6-digit OTP to reset your account credentials."
            ...
            {error && (
              <div className="p-3.5 rounded-2xl bg-rose-500/10 border border-rose-500/20 text-rose-300 text-xs font-semibold flex items-center gap-2.5 animate-fadeIn">
            ...
            {message && (
              <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-300 text-xs font-semibold flex items-center gap-2.5 animate-fadeIn">
              ...
              <>
                ...
                <div className="space-y-3">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl bg-slate-900/80 hover:bg-slate-800 border border-slate-700/80 text-white font-bold text-xs transition duration-200 active:scale-[0.99] disabled:opacity-50 cursor-pointer shadow-sm"
                  >
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl bg-black/90 hover:bg-black border border-slate-700/80 text-white font-bold text-xs transition duration-200 active:scale-[0.99] disabled:opacity-50 cursor-pointer shadow-sm"
                  >
                ...
                <div className="relative flex items-center justify-center">
                  ...
                  <span className="bg-[#0D121F] px-3 text-[10px] font-bold uppercase tracking-wider text-slate-500 absolute">
                ...
                {forgotStep === "email" ? (
                  <form onSubmit={handleForgotSendOtp} className="space-y-4">
                    ...
                    <button
                      ...
                      className="w-full py-3.5 px-4 rounded-2xl bg-gradient-to-r from-[#0057FF] via-[#0085FF] to-[#00A3FF] hover:opacity-95 text-white font-bold text-xs shadow-lg transition active:scale-[0.99] disabled:opacity-60 cursor-pointer flex items-center justify-center gap-2"
                    >
                      {isSubmitting ? (
                        <>
                          <span className="h-3.5 w-3.5 animate-spin rounded-full border-2 border-white border-t-transparent" />
                  ...
                  <form onSubmit={handleForgotVerifyOtp} className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-2xl border border-slate-700/80 bg-slate-900/60 px-4 py-3 text-center font-mono text-base font-bold text-cyan-400 focus:border-blue-500 focus:bg-slate-900 focus:outline-none transition tracking-widest"
                      />
                      <div className="flex items-center justify-between mt-1 text-[11px] text-slate-400">
                        ...
                        <button
                          ...
                          className="font-bold text-cyan-400 hover:text-cyan-300 disabled:text-slate-600 cursor-pointer"
                        >
                    ...
                    <button
                      ...
                      className="w-full py-3.5 px-4 rounded-2xl bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-xs transition cursor-pointer flex items-center justify-center gap-2"
                    >
