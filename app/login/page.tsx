...
function LoginContent() {
  ...
  // Inline Password Reset Completion
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 mt-1">
                {isForgot
                  ...
                  : "Welcome back! Enter your details to access your orders & dashboard."}
              </p>
            </div>
              ...
              <>
                ...
                <div className="relative my-2">
                  ...
                  <div className="relative flex justify-center text-[10px] font-bold uppercase tracking-widest text-slate-500">
                    <span className="bg-[#0D121F] px-3">or continue with email</span>
                  </div>
                </div>
