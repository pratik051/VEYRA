...
function LoginContent() {
  ...
  const handleAppleLogin = async () => {
    if (!appleProvider || !firebaseAuth) {
      setError("Apple Sign-In is currently initializing. Please try again or use Google / Password.");
      pushToast("Apple Sign-In is unavailable.", "error");
      return;
    }
  ...
  const handleEmailLogin = async (e: FormEvent) => {
    ...
    try {
      ...
      pushToast("Welcome back to LINKOVA!", "success");
      router.push(redirectUrl);
    } catch (err: unknown) {
      ...
      <div className="mx-auto max-w-md">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-xs text-slate-400">
            Sign in to track your India cross-border orders and manage your account.
          </p>
        </div>
