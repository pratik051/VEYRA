  ...
  const steps = [
    {
      ...
      desc: "Browse products listed on VEYRA or explore external Indian marketplaces like Amazon India, Flipkart, Myntra, Meesho, Ajio, or Tata CLiQ.",
    ...
    },
    {
      ...
      desc: "VEYRA logistics team verifies seller authenticity, checks weight and computes international shipping, customs, and domestic delivery into a transparent all-inclusive NPR quotation.",
      detail: "Review the quote directly in your account or via WhatsApp/Email."
    },
    {
      number: "04",
      title: "Confirm & Receive",
      desc: "Once you approve the quotation and pay via eSewa, Khalti, or Bank Transfer, VEYRA procures the item, handles customs clearance, and delivers it right to your doorstep anywhere in Nepal.",
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-16">
      ...
      <div className="text-center max-w-2xl mx-auto space-y-3">
        ...
        <h1 className="text-3xl font-extrabold text-neutral-900 sm:text-5xl">How VEYRA Works</h1>
