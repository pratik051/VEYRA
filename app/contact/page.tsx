  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-12">
      ...
      <div className="text-center max-w-xl mx-auto space-y-2">
        ...
        <h1 className="text-3xl font-extrabold text-neutral-900 sm:text-4xl">Contact VEYRA Support</h1>
          ...
          <div className="rounded-3xl border border-neutral-200 bg-white p-6 sm:p-8 shadow-card">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  {loading ? "Sending..." : "Send Message to VEYRA →"}
                </button>
              </form>
            )}
          </div>
            ...
            <div className="space-y-4 text-xs">
              ...
              <div className="flex items-start gap-3 border-t border-neutral-200/60 pt-3">
                ...
                <div>
                  ...
                  <span className="text-neutral-600">hello@veyra.com.np / support@veyra.com.np</span>
                </div>
              </div>
