    ...
    <PolicyTemplate
      ...
      sections={[
        ...
        },
        {
          ...
          content: "Contact our customer care on WhatsApp (+977-9800000000) or email support@linkova.com.np with your Order ID and photos of the defective item. Our team will arrange pickup or return instructions."
        }
      ]}
    />
  );
