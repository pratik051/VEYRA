...
export default function ReturnPolicyPage() {
  return (
    <PolicyTemplate
      ...
      summary="We want you to be completely satisfied with your VEYRA purchase. Read our straightforward return and replacement guidelines."
      sections={[
        {
        ...
        },
        {
          ...
          content: "Contact our customer care on WhatsApp (+977-9800000000) or email support@veyra.com.np with your Order ID and photos of the defective item. Our team will arrange pickup or return instructions."
        }
      ]}
    />
  );
