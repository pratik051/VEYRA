...
export function PolicyPage() {
    ...
    return (
      <PolicyTemplate title="Privacy Policy">
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">1. Information We Collect</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">2. How We Use Your Data</h3>
          <p>
  ...
  if (path.includes('terms')) {
    return (
      <PolicyTemplate title="Terms & Conditions">
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">1. Sourcing Agency Agreement</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">2. Pricing & Currency Exchange</h3>
          <p>
  ...
  if (path.includes('shipping')) {
    return (
      <PolicyTemplate title="Shipping & Customs Policy">
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">1. Delivery Timeline</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">2. Customs & Duties</h3>
          <p>
  ...
  if (path.includes('refund') || path.includes('return') || path.includes('cancellation')) {
    return (
      <PolicyTemplate title="Refund & Cancellation Policy">
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">1. Order Cancellations</h3>
          <p>
        ...
        <section className="space-y-3">
          <h3 className="text-base font-bold text-neutral-900 dark:text-white">2. Damaged or Incorrect Items</h3>
          <p>
  ...
  return (
    <PolicyTemplate title="Product Sourcing Policy">
      <section className="space-y-3">
        <h3 className="text-base font-bold text-neutral-900 dark:text-white">1. Prohibited Items</h3>
        <p>
