              ...
              <>
                <div className="space-y-2.5">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl bg-white border border-slate-300 hover:bg-slate-50 text-slate-800 font-bold text-xs transition cursor-pointer disabled:opacity-50 shadow-xs"
                  >
                  ...
                  <button
                    ...
                    disabled={isSubmitting}
                    className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-2xl bg-black hover:bg-slate-800 text-white font-bold text-xs transition cursor-pointer disabled:opacity-50 shadow-xs"
                  >
                ...
                <form onSubmit={handleSignIn} className="space-y-3.5">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <button
                        ...
                        className="text-[11px] font-bold text-slate-600 hover:text-black cursor-pointer"
                      >
                        Forgot?
                      </button>
                    </div>
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full py-3.5 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-black text-xs transition cursor-pointer disabled:opacity-50 shadow-md"
                  >
                ...
                <div className="pt-2 text-center">
                  <p className="text-xs text-slate-500">
                    ...
                    <Link
                      to={`/signup${redirectUrl !== '/account' ? `?redirect=${encodeURIComponent(redirectUrl)}` : ''}`}
                  ...
                  <form onSubmit={handleForgotVerifyOtp} className="space-y-3.5">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="123456"
                        className="w-full rounded-xl border border-slate-300 p-3 text-center tracking-widest font-mono text-base font-bold text-slate-900 focus:border-black focus:outline-none bg-slate-50/50"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={isSubmitting}
                      className="w-full py-3.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-700 text-white font-black text-xs transition cursor-pointer disabled:opacity-50 shadow-md"
                    >
                    ...
                    <div className="text-center pt-1">
                      <button
                        ...
                        className="text-xs text-slate-500 hover:text-black font-semibold cursor-pointer disabled:opacity-50"
                      >
