  ...
  return (
    <div className="max-w-md mx-auto py-12 px-4 space-y-6">
      <div className="text-center space-y-2">
        ...
        <p className="text-xs text-neutral-400">Join SajiloMarts for seamless cross-border shopping</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-6 rounded-2xl bg-neutral-900 border border-neutral-800 space-y-4">
        ...
        <div className="text-center text-xs text-neutral-400 pt-2">
          Already have an account? <Link to="/login" className="text-amber-400 font-bold">Sign In</Link>
        </div>
      </form>
    </div>
  );
