  ...
  return (
    <div className="space-y-16 sm:space-y-20 pb-12">
      ...
      <section className="pt-2 sm:pt-6">
        ...
        {/* URL Input Card */}
        <div className="max-w-3xl mx-auto bg-white rounded-xl p-5 sm:p-7 border border-neutral-200 shadow-sm space-y-4">
          <div className="space-y-1">
            <label htmlFor="hero-url-input" className="block text-xs font-semibold text-neutral-800 uppercase tracking-wider">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 rounded-lg bg-neutral-50 border border-neutral-200 text-neutral-900 placeholder:text-neutral-400 text-sm focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition"
                />
              </div>

              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 rounded-lg bg-amber-400 hover:bg-amber-500 text-neutral-950 font-semibold px-6 py-3 text-sm transition-colors shadow-xs shrink-0"
              >
          ...
          <div className="pt-2 border-t border-neutral-100 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-neutral-500">
            <span>Amazon India • Flipkart • Myntra • AJIO • Meesho • Nykaa • +10 more</span>
            <span className="text-neutral-400">See your estimated NPR cost before placing your order.</span>
          </div>
        </div>

        {/* Price Transparency Note */}
        <div className="max-w-3xl mx-auto mt-4 bg-amber-50/70 border border-amber-200/80 rounded-lg p-4 text-xs text-amber-950">
      ...
      <section id="how-it-works" className="scroll-mt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {steps.map((step) => (
            <div
              key={step.num}
              className="bg-white p-5 rounded-lg border border-neutral-200 space-y-2 relative"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
          {categories.map((cat) => (
            <Link
              ...
              className="group bg-white rounded-lg border border-neutral-200 hover:border-neutral-300 transition-all p-3 flex items-center gap-3 hover:shadow-2xs"
            >
              <div className="h-12 w-12 rounded-md overflow-hidden bg-neutral-100 shrink-0 border border-neutral-200">
                <img
                  src={cat.image}
                  alt={cat.name}
      ...
      <section className="bg-neutral-900 text-white rounded-xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 border border-neutral-800">
        ...
        <div className="shrink-0">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-lg bg-amber-400 hover:bg-amber-300 text-neutral-950 font-semibold px-6 py-3 text-xs sm:text-sm transition-colors shadow-sm"
          >
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-lg border border-neutral-200 space-y-2">
            <h3 className="text-sm font-semibold text-neutral-900">
      ...
      {/* ── 7. TRACK ORDER ── */}
      <section className="bg-white rounded-xl p-6 sm:p-8 border border-neutral-200 space-y-6">
        ...
        <form onSubmit={handleTrackSubmit} className="max-w-md mx-auto flex gap-2">
          <input
            ...
            className="flex-1 px-4 py-2.5 rounded-lg bg-neutral-50 border border-neutral-200 text-neutral-900 placeholder:text-neutral-400 text-xs focus:bg-white focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition"
          />
          <button
            type="submit"
            className="px-5 py-2.5 rounded-lg bg-neutral-900 hover:bg-neutral-800 text-white text-xs font-semibold transition shrink-0"
          >
            Track Order
          </button>
        </form>
        ...
        <div className="max-w-3xl mx-auto pt-4 border-t border-neutral-100">
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-2 text-center text-[11px]">
            <div className="p-2 rounded bg-neutral-50 border border-neutral-100 font-medium text-neutral-700">
              1. Order Confirmed
            </div>
            <div className="p-2 rounded bg-neutral-50 border border-neutral-100 font-medium text-neutral-700">
              2. Sourcing
            ...
            <div className="p-2 rounded bg-neutral-50 border border-neutral-100 font-medium text-neutral-700 col-span-2 sm:col-span-1">
              5. Delivered
            </div>
          </div>
        </div>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {sampleReviews.slice(0, 3).map((rev) => (
              <div
                key={rev.id}
                className="bg-white p-5 rounded-lg border border-neutral-200 space-y-3 flex flex-col justify-between"
              >
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full p-4 text-left flex items-center justify-between gap-4 text-sm font-semibold text-neutral-900 hover:bg-neutral-50 transition"
                >
                  <span>{faq.q}</span>
                  <ChevronDown
