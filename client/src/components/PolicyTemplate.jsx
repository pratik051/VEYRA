  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8 sm:py-12 space-y-8">
      ...
      <div className="space-y-3 border-b border-neutral-100 pb-6">
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-neutral-100 text-neutral-800 text-[11px] font-extrabold uppercase">
          <Shield className="h-3.5 w-3.5 text-neutral-950" />
      ...
      <div className="rounded-3xl bg-neutral-950 text-white p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-4 mt-12">
        ...
        <Link
          to="/contact"
          className="rounded-full bg-amber-400 text-neutral-950 hover:bg-white px-6 py-2.5 text-xs font-bold transition shadow-xs shrink-0"
        >
          Contact Support ➔
        </Link>
      </div>
