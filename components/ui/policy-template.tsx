  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8 space-y-8">
      ...
      <div className="border-b border-neutral-200 pb-6 space-y-2">
        ...
        <p className="text-xs text-neutral-500">Last updated: {lastUpdated} • VEYRA Retail Nepal</p>
      </div>
      ...
      <div className="border-t border-neutral-200 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-neutral-500">
        ...
        <div className="flex gap-4 font-semibold text-neutral-900">
          <Link href="/contact" className="hover:text-veyra-gold transition">
            Contact Support →
          </Link>
          <Link href="/faq" className="hover:text-veyra-gold transition">
            View FAQ →
          </Link>
        </div>
      </div>
