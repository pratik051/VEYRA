...
export function SupportChat({ embedded = false }: { embedded?: boolean }) {
  ...
  }, [messages, open, loading, embedded]);
      ...
      >
        ...
        <div className="flex items-center justify-between bg-neutral-950 px-4 sm:px-5 py-3 text-white">
          ...
          <button
            type="button"
            onClick={resetChat}
            className="rounded-lg px-2.5 py-1 text-xs font-semibold text-neutral-300 hover:bg-white/10 hover:text-white transition"
          >
            Reset Chat
          </button>
        </div>
        ...
        <div className="border-t border-neutral-200 bg-white p-3">
          ...
          >
            ...
            <input
              ...
              maxLength={500}
              placeholder="Ask about products, order tracking, payment options..."
