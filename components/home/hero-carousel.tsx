...
const slides = [
  ...
  {
    id: 2,
    brand: "Direct Marketplace Concierge",
    badge: "🇮🇳 SEAMLESS SOURCING",
    title: "Found It On Amazon or Flipkart? We Deliver.",
    desc: "Order direct from verified sellers in India with clear NPR pricing, transparent customs and doorstep delivery.",
    buttonText: "Request Any Product",
    buttonLink: "/request-product",
    image: "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?auto=format&fit=crop&w=1200&q=80",
    gradient: "from-neutral-950 via-amber-950/70 to-neutral-950"
  },
  {
    id: 3,
...
export function HeroCarousel() {
  ...
  return (
    <div className="relative flex-1 overflow-hidden rounded-3xl bg-neutral-950 text-white min-h-[380px] sm:min-h-[440px] lg:min-h-[460px] flex items-center shadow-xl border border-white/10">
      {/* Background Image with Neo Multi-stop Overlay */}
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          priority
          className="object-cover object-center opacity-40 mix-blend-luminosity scale-105 transition-all duration-700"
        />
      ...
      {/* Hero Content */}
      <div className="relative z-10 p-6 sm:p-10 lg:p-14 max-w-xl space-y-4 sm:space-y-6">
        <div className="flex flex-wrap items-center gap-2.5">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/15 backdrop-blur-md text-[11px] font-extrabold text-amber-300 border border-white/10">
            {slide.badge}
          </span>
        ...
        <h1 className="font-display text-3xl sm:text-5xl font-black tracking-tight leading-[1.15] text-white drop-shadow-md">
          {slide.title}
        </h1>
        ...
        <div className="pt-2 flex flex-wrap items-center gap-4">
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-white text-neutral-950 px-7 py-3.5 text-xs sm:text-sm font-extrabold shadow-lg hover:bg-amber-300 transition-all duration-200 hover:scale-105 active:scale-95"
          >
          ...
          <Link
            ...
            className="inline-flex items-center gap-2 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-md text-white px-6 py-3.5 text-xs sm:text-sm font-bold border border-white/15 transition-all duration-200"
          >
